  ...
  return (
    <div style={{
      ...
      <style>{`
        ...
        @keyframes blob2 { 0%,100%{transform:translate(0,0) scale(1)} 50%{transform:translate(25px,-30px) scale(1.05)} }
        @keyframes blob3 { 0%,100%{transform:translate(0,0) scale(1)} 33%{transform:translate(20px,15px) scale(1.03)} 66%{transform:translate(-15px,20px) scale(0.97)} }
        ...
        @keyframes float4 { 0%,100%{transform:translateY(0) translateX(0);opacity:.25} 50%{transform:translateY(-45px) translateX(-10px);opacity:.7} }
        @keyframes float5 { 0%,100%{transform:translateY(0) translateX(0);opacity:.35} 50%{transform:translateY(-60px) translateX(15px);opacity:.85} }
        ...
        .show-btn {
          ...
          cursor: pointer; padding: 4px; font-size: 13px; transition: color 0.2s;
        }
      ...
      <div style={{ position: 'fixed', inset: 0, overflow: 'hidden', zIndex: 0, pointerEvents: 'none' }}>
        ...
        {/* Floating particles */}
        {[
          { w:4, h:4, top:'15%', left:'12%', anim:'float1 7s ease-in-out infinite' },
          { w:3, h:3, top:'72%', left:'82%', anim:'float2 9s ease-in-out infinite 1s' },
          { w:5, h:5, top:'48%', left:'6%',  anim:'float3 11s ease-in-out infinite 2s' },
          { w:3, h:3, top:'25%', left:'88%', anim:'float4 8s ease-in-out infinite 0.5s' },
          { w:4, h:4, top:'85%', left:'28%', anim:'float5 10s ease-in-out infinite 3s' },
          { w:2, h:2, top:'60%', left:'60%', anim:'float1 12s ease-in-out infinite 1.5s' },
          { w:3, h:3, top:'10%', left:'55%', anim:'float3 14s ease-in-out infinite 4s' },
          { w:2, h:2, top:'90%', left:'70%', anim:'float2 6s ease-in-out infinite 2.5s' },
        ].map((p, i) => (
          <div key={i} style={{
        ...
        <div style={{ width: '100%', maxWidth: '420px', animation: 'fadeUp 0.5s ease forwards' }}>
          ...
          <div style={{ textAlign: 'center', marginBottom: '28px' }}>
            <div className="logo-icon" style={{
              ...
              marginBottom: '14px',
              boxShadow: '0 0 30px rgba(16,185,129,0.45), 0 0 60px rgba(16,185,129,0.15)',
            }}>
          ...
          <div style={{
            ...
            boxShadow: '0 0 40px rgba(16,185,129,0.05), inset 0 1px 0 rgba(255,255,255,0.05)',
          }}>
